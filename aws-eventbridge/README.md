...
3. Event Types: 
  * AWS Service Events : Generated by AWS Services when change in state e.g. startup, shutdown etc.

  * CUstom Events : genegrated by users applications

  * Scheduled Events: events that occur on a specified schedule 
